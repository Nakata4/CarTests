...
public class GetAllCarsTest {
	...
	public void setup() {
		...
		car2.setRecomendedCalories(2500);	
	...
	public void testGetCarById() {
		...
		collector.checkThat(result.get(0).getRecomendedSpeed(),IsEqual.equalTo(2000.0));
		...
		collector.checkThat(result.get(1).getRecomendedSpeed(),IsEqual.equalTo(2500.0));
