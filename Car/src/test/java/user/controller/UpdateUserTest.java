...
public class UpdateUserTest {
	@Parameters(name = "{index}: with id = {0} , email = {1}, username = {2}, password = {3}, repeatPassword = {4}, carId = {5}, loggedUser = {6}, car= {7} and expected result={8}")
	public static Iterable<Object[]> data() {
		return Arrays.asList(new Object[][] { //
				...
				{ 2,"email5@mail.com", "name", "pass", "pass", "0",
						new UserBean("username", "password", "email@email.com"), "CAR_USER", "Error Unauthorized!" }, });
	}
	@Parameter(0)
	public int id;
	@Parameter(1)
	...
	public void testUpdateUser() {
		final List<String> result = userController.updateUser(id,email, username, password, repeatPassword, carId,
				principal);
